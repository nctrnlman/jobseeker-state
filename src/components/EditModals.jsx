...
function EditModals({ isOpen, closeModal, editingCandidate, fetchData }) {
  ...
  useEffect(() => {
    if (editingCandidate) {
      ...
      setPhoneNumber(editingCandidate.phone_number || "");
      setDob(editingCandidate.dob || "");
      setPob(editingCandidate.pob || "");
      setGender(editingCandidate.gender || "");
      setYearExp(editingCandidate.year_exp || "");
      setLastSalary(editingCandidate.last_salary || "");
    }
  }, [editingCandidate]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:8001/candidates/${editingCandidate.candidate_id}`,
        updatedCandidate
      );
